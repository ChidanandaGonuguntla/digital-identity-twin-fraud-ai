...
public class DigitalTwinService {
    ...
    public CustomerTwin createTwin(CreateTwinRequest request) {
        if (!identityRepository.existsByCustomerId(request.customerId())) {
            identityRepository.save(CustomerIdentity.builder()
        ...
        CustomerTwin twin = twinRepository.findByCustomerId(request.customerId()).orElseGet(CustomerTwin::new);
    ...
    public CustomerTwin getTwin(String customerId) {
        return twinRepository.findByCustomerId(customerId)
